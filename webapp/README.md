...
If you want to run CLARA&bull;T with HTTPS, you need to create a certificate and sign it with a Certificate Authority (CA) that is trusted locally by your device and browser. You have a couple of options on how to do this:
...
### Step 2: Configuring CLARA&bull;T Chat to use the certificate
...
1. Restart the `webapi` and `webapp` - CLARA&bull;T Chat should be now running locally with HTTPS.
